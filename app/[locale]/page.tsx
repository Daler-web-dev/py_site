	...
	return (
		<main className="px-4 md:px-20 h-full md:h-screen flex flex-col-reverse gap-5 justify-end laptop:flex-row  laptop:justify-between items-center pt-[50px] laptop:pb-[0px] pb-[50px] overflow-hidden">
			<div className="flex flex-col gap-6 items-start w-full">
				<div>
					<h2 className="tracking-wide mb-2 fhd:text-2xl">{t("fullName")}</h2>
					<h1 className="text-2xl font-medium md:text-5xl fhd:text-8xl">
						{t("title")}
					</h1>
				</div>
				<p className="md:w-[50ch] w-full fhd:text-3xl">{t("description")}</p>
				<div className="flex items-center gap-2">
					<span className="py-0 font-light opacity-50 fhd:text-2xl">
						{t("socMedia")}:
					</span>
